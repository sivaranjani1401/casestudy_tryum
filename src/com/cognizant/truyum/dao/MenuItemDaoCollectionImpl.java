   ...
   MenuItemDaoCollectionImpl() throws Exception
   {
	   ...
	   if(menuItemList == null || menuItemList.isEmpty())
	   {
		   ...
		   menuItemList.add(new MenuItem(01, "Sandwich", "Main Course", 99.0f, true,true,DateUtil.convertToDate("15/03/2017")));
			...
			menuItemList.add(new MenuItem(02, "Burger", "Main Course",(float) 129.0, true,false,DateUtil.convertToDate("23/12/2017")));

			menuItemList.add(new MenuItem(03, "Pizza","Main Course", (float) 149.0, true,false ,DateUtil.convertToDate("21/08/2018")));
